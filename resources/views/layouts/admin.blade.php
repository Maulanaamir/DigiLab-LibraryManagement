        ...
        <div>
            ...
            <nav class="p-4 space-y-2 mt-2">
                ...
                <a href="{{ route('admin.users.index') }}"
                    class="flex items-center gap-3 px-4 py-3 text-[#900b21] hover:bg-[#fce8eb] rounded-xl font-medium transition-colors {{ request()->routeIs('admin.users.*') ? 'bg-[#fce8eb] text-[#900b21] font-semibold' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
