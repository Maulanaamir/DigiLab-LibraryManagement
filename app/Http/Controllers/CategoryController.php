...
class CategoryController extends Controller
{
    ...
    {
        // namanya wajib diisi, maksimal 255 huruf, dan nggak boleh ada kategori kembar (unique)
        $request->validate([
    ...
    {
        $request->validate([
            // Validasi unik, tapi biarin ID kategori yang sedang diedit ini
    ...
    public function destroy(Category $category)
    {
        ...
        // Kalau aman (nggak ada buku yang pakai), baru di hapus
        $category->delete();
